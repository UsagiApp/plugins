package org.koitharu.kotatsu.parsers.site.all.tachiyomi
...
@TachiyomiSource(name = "HOLONOMETRIA_JA", title = "Holonometria (JA)", locale = "ja")
class HolonometriaJA : Holonometria("") // Alternatives to SourceFactory

@TachiyomiSource(name = "HOLONOMETRIA_EN", title = "Holonometria (EN)", locale = "en")
class HolonometriaEN : Holonometria("en") // Alternatives to SourceFactory

@TachiyomiSource(name = "HOLONOMETRIA_ID", title = "Holonometria (ID)", locale = "id")
class HolonometriaID : Holonometria("id") // Alternatives to SourceFactory

// @TachiyomiSource() is required for any Tachiyomi extension (as a mapping layer)
open class Holonometria(
    ...
    companion object {
        private val manga = listOf("manga", "gambar", "æ¼«ç”»")
        private val script = listOf("script", "naskah", "è„šæœ¬")
